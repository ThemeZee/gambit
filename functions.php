...
/**
 * Gambit only works in WordPress 4.2 or later.
 */
...
function gambit_widgets_init() {
	...
	register_sidebar( array(
		...
		'description' => esc_html__( 'Appears on Magazine Homepage template only. You can use the Magazine Posts widgets here.', 'gambit' ),
...
function gambit_scripts() {
	...
	wp_enqueue_style( 'gambit-stylesheet', get_stylesheet_uri() );
	
	// Register Genericons
	wp_enqueue_style( 'gambit-genericons', get_template_directory_uri() . '/css/genericons/genericons.css' );
	
	// Register and Enqueue HTML5shiv to support HTML5 elements in older IE versions
	wp_enqueue_script( 'gambit-html5shiv', get_template_directory_uri() . '/js/html5shiv.min.js', array(), '3.7.2', false );
	$wp_scripts->add_data( 'gambit-html5shiv', 'conditional', 'lt IE 9' );

	// Register and enqueue navigation.js
	wp_enqueue_script( 'gambit-jquery-navigation', get_template_directory_uri() .'/js/navigation.js', array('jquery') );
	...
	wp_enqueue_style( 'gambit-default-fonts', gambit_google_fonts_url(), array(), null );
...
function gambit_google_fonts_url() {
    ...
    return apply_filters( 'gambit_google_fonts_url', $fonts_url );
}
