 ...
 */
function gambit_customize_register_website_settings( $wp_customize ) {
	...
	$wp_customize->add_control( new Gambit_Customize_Header_Control(
		$wp_customize, 'gambit_theme_options[retina_logo_title]', array(
			'label'    => esc_html__( 'Retina Logo', 'gambit' ),
	...
	$wp_customize->add_setting( 'gambit_theme_options[retina_logo]', array(
		'default'           => false,
		'type'              => 'option',
		'transport'         => 'refresh',
	...
	$wp_customize->add_control( 'gambit_theme_options[retina_logo]', array(
		'label'    => esc_html__( 'Scale down logo image for retina displays', 'gambit' ),
		'section'  => 'title_tagline',
		'settings' => 'gambit_theme_options[retina_logo]',
		'type'     => 'checkbox',
		'priority' => 9,
	) );
...
add_action( 'customize_register', 'gambit_customize_register_website_settings' );
