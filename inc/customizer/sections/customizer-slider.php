...
function gambit_customize_register_slider_settings( $wp_customize ) {
	...
	$wp_customize->add_section( 'gambit_section_slider', array(
	...
	$wp_customize->add_setting( 'gambit_theme_options[slider_activate]', array(
        'default'           => '',
		'type'           	=> 'option',
        'transport'         => 'refresh',
    ...
    $wp_customize->add_control( new Gambit_Customize_Header_Control(
        $wp_customize, 'gambit_theme_options[slider_activate]', array(
	...
	$wp_customize->add_setting( 'gambit_theme_options[slider_magazine]', array(
        'default'           => false,
		'type'           	=> 'option',
        'transport'         => 'refresh',
    ...
    $wp_customize->add_control( 'gambit_theme_options[slider_magazine]', array(
	...
	$wp_customize->add_setting( 'gambit_theme_options[slider_blog]', array(
        'default'           => false,
		'type'           	=> 'option',
        'transport'         => 'refresh',
        'sanitize_callback' => 'gambit_sanitize_checkbox'
    ...
    $wp_customize->add_control( 'gambit_theme_options[slider_blog]', array(
	...
	$wp_customize->add_setting( 'gambit_theme_options[slider_category]', array(
        'default'           => 0,
		'type'           	=> 'option',
        'transport'         => 'refresh',
    ...
    $wp_customize->add_control( new Gambit_Customize_Category_Dropdown_Control(
        $wp_customize, 'gambit_theme_options[slider_category]', array(
	...
	$wp_customize->add_setting( 'gambit_theme_options[slider_limit]', array(
        'default'           => 8,
		'type'           	=> 'option',
        'transport'         => 'refresh',
        'sanitize_callback' => 'absint'
    ...
    $wp_customize->add_control( 'gambit_theme_options[slider_limit]', array(
	...
	$wp_customize->add_setting( 'gambit_theme_options[slider_animation]', array(
        'default'           => 'slide',
		'type'           	=> 'option',
        'transport'         => 'refresh',
    ...
    $wp_customize->add_control( 'gambit_theme_options[slider_animation]', array(
	...
	$wp_customize->add_setting( 'gambit_theme_options[slider_speed]', array(
        'default'           => 7000,
		'type'           	=> 'option',
        'transport'         => 'refresh',
        'sanitize_callback' => 'absint'
    ...
    $wp_customize->add_control( 'gambit_theme_options[slider_speed]', array(
