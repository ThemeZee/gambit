...
( function( $ ) {
	...
	// Post Date checkbox.
	wp.customize( 'gambit_theme_options[meta_date]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'gambit_theme_options[meta_author]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'gambit_theme_options[meta_category]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	// Post Tags checkbox.
	wp.customize( 'gambit_theme_options[meta_tags]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
	...
	wp.customize( 'gambit_theme_options[post_navigation]', function( value ) {
		value.bind( function( newval ) {
			if ( false === newval ) {
